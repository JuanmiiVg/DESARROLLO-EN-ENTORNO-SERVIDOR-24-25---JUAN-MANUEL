    ...
    <table class="table table-bordered">
        ...
        <?php foreach ($animales as $animal): ?>
            <tr>
                ...
                <td> <a href="/animales/<?= $animal['id_animal'] ?>" class="btn btn-link btn-sm"><?= $animal['nombre'] ?></a></td>
                <td><?= $animal['especie'] ?></td>
                <td><?= $animal['edad'] ?></td>
                <td>
                    <a href="/animales/<?= $animal['id_animal'] ?>/modificar" class="btn btn-warning btn-sm">Editar</a>
